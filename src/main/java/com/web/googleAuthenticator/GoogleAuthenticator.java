 ...
 */
package com.web.googleAuthenticator;
...
public class GoogleAuthenticator {
    ...
    public static void main(String[] args) {
        ...
        String key = "46WGJQII462W53JR";
        // String key = "XSY3V4NODG5DTTNO";
        // System.out.println(genSecret());
        // System.out.println(generateSecretKey());

        System.out.println(authcode("401533",key));
//
//        long code = 989444;
...
//        System.out.println("Check code = " + r);
    ...
    public static String genSecret() {
        ...
        // 获取二维码的地址
        String qRCode = GoogleAuthenticator.getQRBarcodeURL("testuser",
                "Leon.local", secret);
        return qRCode;
    }
